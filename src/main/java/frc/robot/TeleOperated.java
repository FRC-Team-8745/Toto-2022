...
public class TeleOperated {
	private MotorNames right;
	private MotorNames left;
	private MotorNames intake;
	private MotorNames climberRight;
	private MotorNames climberLeft;
	private MotorNames turret;
	// Joystick Import
	private Joystick cont;
	// Xbox Import
	private XboxController xbox;
	private ShootFunction autoShooter;

	public TeleOperated(MotorNames right_, MotorNames left_, MotorNames shooter_, MotorNames intake_,
			Spark loader_, MotorNames climberRight_, MotorNames climberLeft_, MotorNames turret_, Joystick cont_,
			XboxController xbox_, ShootFunction autoShooter_) {
		right = right_;
		left = left_;
		intake = intake_;
